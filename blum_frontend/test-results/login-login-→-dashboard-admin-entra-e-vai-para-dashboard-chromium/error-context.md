...
- Name: login.spec.js >> login → dashboard >> admin entra e vai para /dashboard
- Location: e2e\login.spec.js:7:3
...
- generic [ref=e3]:
  ...
  - generic [ref=e32]:
    ...
    - generic [ref=e40]:
      - generic [ref=e41]:
        - generic [ref=e42]: E-mail ou usuário
        - generic [ref=e43]:
          - generic:
            - img
          - textbox "E-mail ou usuário" [ref=e44]:
      ...
      - generic [ref=e45]:
        ...
        - generic [ref=e47]:
          ...
          - textbox "Senha" [ref=e48]:
            ...
            - text: BlumAdmin2025!
          - button "Mostrar senha" [ref=e49] [cursor=pointer]:
            - img [ref=e50]
      - button "Acessar outra empresa" [ref=e52] [cursor=pointer]
      - button "Entrar" [ref=e53] [cursor=pointer]
    - paragraph [ref=e55]:
      - text: Primeira vez no Blum?
      - link "Criar empresa" [ref=e56] [cursor=pointer]:
        - /url: /signup
```
